...
public class MainActivity extends AppCompatActivity {
    ...
    ImageButton pencil, circle, rectangle, text, red, green, blue, yellow, cyan, purple,black;
    DrawingView canvas;
    ...
    public void SelectColor(View view) {
        switch (view.getId()) {
            case R.id.red: {
                ...
                black.setBackground(getDrawable(R.drawable.color_black));
            ...
            case R.id.black: {
                ...
                cyan.setBackground(getDrawable(R.drawable.color_cyan));
                purple.setBackground(getDrawable(R.drawable.color_purple));
                black.setBackground(getDrawable(R.drawable.selected_color_black));
                break;
            }
        }
    }
